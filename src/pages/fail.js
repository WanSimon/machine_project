    ...
    return (
      <View style={customStyle.container}>
        ...
        <View style={{
          ...
          }}>流水订单号：{this.state.serial_no}</Text>
        </View>
            ...
            {this.state.productList.map(item =>
              <View style={ customStyle.productItem }>
                ...
                <View style={customStyle.productInfo}>
                  <Text style={customStyle.productName}>
                    {item.name}
                  </Text>
                  <Text style={customStyle.productStatus}>{this.parseStatus(item.status)}</Text>
                </View>
              </View>
            )}
          </ScrollView>
        ...
        <View
          ...
          {this.state.applyRefundUrl?<QRCode
            size={p2dWidth(175)}
