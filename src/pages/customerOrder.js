...
class customerOrder extends Component {
  ...
  async componentDidMount(){
    ...
    NativeModules.RaioApi.debug({msg: `customerOrder page get reducex orderInfo = ${JSON.stringify(orderInfo)}`, method: 'customerOrder.componentDidMount'}, null);
    ...
    NativeModules.RaioApi.debug({msg: `customerOrder page rebuild orderInfo = ${JSON.stringify(orderInfo)}`, method: 'customerOrder.componentDidMount'}, null);
  ...
  async submitOrder(orderInfo){
    NativeModules.RaioApi.debug({msg: 'customerOrder page submitOrder start', method: 'customerOrder.submitOrder'}, null);
    try{
      let res = await api.submitOrder(orderInfo);
      NativeModules.RaioApi.debug({msg: `customerOrder page submitOrder success, ${JSON.stringify(res)}`, method: 'customerOrder.submitOrder'}, null);
    }catch (e) {
      console.error(e);
      NativeModules.RaioApi.debug({msg: `customerOrder page submitOrder fail, ${e.message}`, method: 'customerOrder.submitOrder'}, null);
    }
    NativeModules.RaioApi.debug({msg: 'customerOrder page submitOrder end', method: 'customerOrder.submitOrder'}, null);
  }
