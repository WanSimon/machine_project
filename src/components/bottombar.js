  ...
  render() {
    return (
      <View style={{
        ...
        {this.props.productNum>0?<View style={{
          position:'absolute',
          left:p2dWidth(172),
          top:p2dHeight(16),
          width:p2dWidth(60),
        ...
        >
          <Text style={{
            ...
            fontWeight:'500',
            color:'#333333'
          }}>¥ {parseCent(this.props.totalPrice)}</Text>
        </View>
        ...
        <View style={{
          ...
          backgroundColor:this.props.productNum>0?$conf.theme:'#BEBEBE',
          ...
          }} onPress={()=>{if(this.props.productNum>0) {this.props.goOrder()}}}>提交订单</Text>
        </View>
      </View>
    );
  }
