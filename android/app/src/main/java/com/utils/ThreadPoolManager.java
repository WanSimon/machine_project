...
public class ThreadPoolManager {
    ...
    private ThreadPoolManager() {
        //threadPoolExecutor = new ThreadPoolExecutor(10, 30, 20, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(10), rejectedExecutionHandler);
        //运行线程池
        //threadPoolExecutor.execute(runnable);
        threadPoolExecutor = new ThreadPoolExecutor(10, 30, 20, TimeUnit.SECONDS, new LinkedBlockingDeque<>());
    }
